...
generated_at: 2026-04-22T01:19:30.0391611Z
---
...
| Path | Notes |
| --- | --- |
| `examples/basic_ops.aura` | source example |
| `examples/basic_ops.ir.aura` | checked IR example |
| `examples/basic_ops.ir.json` | serialized IR artifact |
| `examples/broken_interface_bound.aura` | negative example for diagnostics |
...
| `examples/hello_world.aura` | source example |
